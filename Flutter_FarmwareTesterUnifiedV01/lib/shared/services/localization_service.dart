...
class LocalizationService {
  ...
  static final Map<AppLanguage, Map<String, String>> _translations = {
    ...
    AppLanguage.zhTW: {
      ...
      // 自動檢測 — 僅 BodyDoor 使���
      'power_33v_anomaly': '3.3V ��源異常（ID 6,8,9,10,11 數值全部過低）',
      ...
      'rules_d12v_short_cond2': '（Idle 超標時自動跳過 Running，保護 MOSFET）',
      'rules_d12v_short_feature': '特徵：Arduino ADC 接近飽和值（10-bit ADC 最大 1023）',
      'rules_d12v_short_reason': '原因：D極被 12V 強制拉高，導通即燒毀',
      ...
      'rules_ds_short_cond1': '1. Arduino Idle 在 25 ~ 60（偏低）',
      'rules_ds_short_cond2': '2. STM32 Idle < 10 且 Running < 10（都接近 0）',
      ...
      'rules_gs_short_cond1': '1. Arduino Running 在 700 ~ 850（維持在 Idle 水平）',
      'rules_gs_short_cond2': '2. STM32 Running > 400 且 Idle < 50',
    ...
    AppLanguage.en: {
      ...
      'rules_d12v_short_cond2': '(Auto-skip Running when Idle exceeds threshold, protect MOSFET)',
      'rules_d12v_short_feature': 'Feature: Arduino ADC near saturation (10-bit ADC max 1023)',
      'rules_d12v_short_reason': 'Cause: Drain forced high by 12V, conduction burns MOSFET',
      ...
      'rules_ds_short_cond1': '1. Arduino Idle in 25 ~ 60 (low value)',
      'rules_ds_short_cond2': '2. STM32 Idle < 10 and Running < 10 (both near 0)',
      ...
      'rules_gs_short_cond1': '1. Arduino Running in 700 ~ 850 (stays at Idle level)',
      'rules_gs_short_cond2': '2. STM32 Running > 400 and Idle < 50',
