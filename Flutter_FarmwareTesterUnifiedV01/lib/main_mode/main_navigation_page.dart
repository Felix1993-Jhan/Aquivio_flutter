// ============================================================================
// MainNavigationPage - Main Board 主導航頁面
// ============================================================================
// 功能說明：
// 本模式用於同時管理 Arduino 和 STM32U073MCT6 兩組 USB 串口通訊
// ============================================================================
...
class MainNavigationPage extends StatefulWidget {
  ...
  const MainNavigationPage({super.key, this.initialArduinoPort});
...
class _MainNavigationPageState extends State<MainNavigationPage>
  ...
  void _showWrongModeDialog(String detectedPort) {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          tr('main_wrong_mode_detected_message'),
        ),
        actions: [
          TextButton(
            onPressed: () {
          ...
          ElevatedButton.icon(
            onPressed: () {
              ...
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => BodyDoorNavigationPage(initialArduinoPort: detectedPort),
                ),
              );
            },
            icon: const Icon(Icons.swap_horiz),
            label: Text(tr('switch_to_bodydoor_mode')),
  ...
  String _getPageTitle() {
    switch (_selectedPageIndex) {
      case 0:
        return tr('main_page_auto_detection');
      case 1:
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              final text = _flowController.text.trim();
              if (text.isEmpty) return;
              final value = int.tryParse(text);
              if (value == null || value < 125 || value > 5000) {
                return;
              }
              sendArduinoCommand('flow$text');
            },
            style: ElevatedButton.styleFrom(
      ...
      children: [
        ...
        Expanded(
          child: ArduinoPanel(
            ...
            extraCommandWidget: _buildFlowInput(),
